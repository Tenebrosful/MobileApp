...
/*Future<Event> joinEvent(bool comeToEvent, String id, String username) async {
  final response = await http.post(
    Uri.parse(
        'http://docketu.iutnc.univ-lorraine.fr:62460/api/event/fdb8da9e-a936-11ec-baf8-0242ac160002/participants'),
